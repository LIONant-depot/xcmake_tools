...
function(DefineInterfaceComponent COMP_NAME GROUP)
  ...
  if(NOT TARGET ${COMP_NAME})
    ...
    if("${COMP_NAME}" MATCHES "^${TARGET_PROJECT}$|^${TARGET_PROJECT}_.*|${TARGET_PROJECT}")
      message(STATUS "Component '${COMP_NAME}' matches with project '${TARGET_PROJECT}'. We won't treat the component as a dependency")
      set(ROOT ".")
    else()
